...
//				processCustomMessage(context, bundle);
                ...
                Log.e(TAG,"---收到了自定义消息。消息内容是：" + message);
                String extra = bundle.getString(JPushInterface.EXTRA_EXTRA);
                Log.e(TAG,"---收到了自定义消息。extra是：" + extra);

                CustomMessage messages = new CustomMessage();
                messages.setMessage(bundle.getString(JPushInterface.EXTRA_EXTRA));
                ...
                stopBean.setVideoId(bundle.getString(JPushInterface.EXTRA_EXTRA));
                EventBus.getDefault().post(stopBean);
