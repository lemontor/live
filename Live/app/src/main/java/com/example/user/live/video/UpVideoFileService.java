 ...
 */
public class UpVideoFileService extends Service {
    ...
    public void fromActivityEvent(FromActivityEventBean activityEventBean) {
        if (activityEventBean != null) {
            if (activityEventBean.getEvent() == 1) {//开始
                ...
                ftpUpLoadUtils.reUpload(UpVideoFileService.this,entity);
    ...
    public int onStartCommand(Intent intent, int flags, int startId) {
        ...
        ftpUpLoadUtils.uploadFile(UpVideoFileService.this, infoEntity);
